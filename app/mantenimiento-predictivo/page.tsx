export default function MantenimientoPredictivoPage() {
  const trabajos = [
    ...
    "Análisis de tendencia y evolución de fallas",
    "Evaluación de estado de rodamientos",
    "Control de desalineaciones y desbalances",
    ...
    <div className="flex items-center gap-10">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-6 text-slate-300">
              El mantenimiento predictivo permite anticipar fallas antes de que
              se conviertan en problemas críticos, optimizando la confiabilidad
              de los equipos y mejorando la planificación del mantenimiento.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-10">
        <div>
          ...
          <p className="mt-4 text-slate-700">
            A través del monitoreo de condición, el mantenimiento predictivo
            permite identificar cambios en el comportamiento del equipo y
            anticipar intervenciones antes de que ocurra una falla.
          </p>
        </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-4 text-slate-700">
            También brindamos capacitación técnica para personal de mantenimiento,
            orientada a mejorar la detección de fallas y la interpretación de datos
