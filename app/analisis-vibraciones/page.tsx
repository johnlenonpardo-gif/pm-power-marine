export default function VibracionesPage() {
  const trabajos = [
    "Medición de vibraciones en equipos rotativos",
    "Diagnóstico de desbalanceos",
    "Detección de desalineaciones",
    "Análisis de rodamientos",
    "Identificación de fallas mecánicas",
    ...
    <div className="flex items-center gap-10">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-6 text-slate-300">
              Diagnóstico técnico para detectar fallas en equipos rotativos
              antes de que se conviertan en problemas críticos.
            </p>
          </div>

          <img
            src="/vibraciones1.jpg"
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-10">
        <div>
          ...
          <p className="mt-4 text-slate-700">
            El análisis de vibraciones permite evaluar el estado de equipos
            rotativos y anticipar fallas mediante mediciones y diagnóstico técnico.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          <img src="/vibraciones1.jpg" className="h-80 w-full rounded-3xl object-cover shadow-lg" />
          <img src="/vibraciones2.jpg" className="h-80 w-full rounded-3xl object-cover shadow-lg" />
          <img src="/vibraciones3.jpg" className="h-80 w-full rounded-3xl object-cover shadow-lg" />
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-4 text-slate-700">
            También brindamos capacitación técnica en diagnóstico de vibraciones,
            orientada a personal de mantenimiento para mejorar la detección de fallas.
          </p>
        </div>
      </section>
